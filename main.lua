...
elseif game.PlaceId == 17290438723 then
    local Window = Library:CreateWindow({
        Title = "PleebGUI - Frostbite Map Obby",
        Center = true,
        AutoShow = true,
        Resizable = true,
        AutoLock = true,
...
task.spawn(function()
    -- Wait a brief moment to ensure LinoriaLib is fully loaded
    task.wait(0.5) 
    
    if Library then
        Library.AccentColor = Color3.fromRGB(0, 130, 255) -- Secondary/Accent Blue
        Library.BackgroundColor = Color3.fromRGB(12, 12, 12) -- Deep Black Background
        Library.MainColor = Color3.fromRGB(18, 18, 18) -- Dark Gray/Black Main Panels
        Library.OutlineColor = Color3.fromRGB(40, 40, 40) -- Subtle Dark Outlines
        Library.FontColor = Color3.fromRGB(245, 245, 245) -- Crisp White Text
        
        -- Force the library to update all existing UI elements to the new colors
